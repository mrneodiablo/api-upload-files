...
rec {
  ...
  connector-c = super.stdenv.mkDerivation rec {
    buildInputs = [ super.libiconv ];
    cmakeFlags = [
    ...
    preConfigure = super.stdenv.lib.optionalString super.stdenv.isDarwin ''
      cmakeFlagsArray+=("-DCMAKE_INSTALL_NAME_DIR=$out/lib/mariadb")
    '';
    propagatedBuildInputs = [ super.openssl super.zlib ];
    src = super.fetchurl {
  ...
  django = super.python27Packages.buildPythonPackage rec {
    doCheck = false;
    name = "Django-${version}";
    propagatedBuildInputs = [ super.python27Packages.pytz ];
    src = super.fetchurl {
  ...
  django-docs = super.python27Packages.buildPythonPackage rec {
    doCheck = false;
  ...
  django-filter = super.python27Packages.buildPythonPackage rec {
    doCheck = false;
  ...
  djangorestframework = super.python27Packages.buildPythonPackage rec {
    doCheck = false;
  ...
  MySQL-python = super.python27Packages.buildPythonPackage rec {
  ...
  requests = super.python27Packages.buildPythonPackage rec {
    doCheck = false;
    name = "requests-${version}";
    propagatedBuildInputs = [
      super.python27Packages.chardet
      super.python27Packages.urllib3 ];
    src = super.fetchurl {
  ...
  SQLAlchemy = super.python27Packages.buildPythonPackage rec {
    doCheck = false;
  ...
  uwsgi = super.python27Packages.buildPythonPackage rec {
    doCheck = false;
    name = "uwsgi-${version}";
    src = super.fetchurl {
  ...
  python4app = super.python27.withPackages ( ps: [ ps.pip ps.requests django django-docs django-filter djangorestframework MySQL-python SQLAlchemy uwsgi ]);
